...
// In this exercise you'll implement the mergesort algorithm
// for data represented as linked lists.
//
// We will proceed step by step.
//
// We use the same structure definition for the list as we did
// in our linked list implementations for IntStack and IntQueue.
struct ListNode {
    int              item;
    struct ListNode* next;
};

typedef struct ListNode* List; // for brevity
